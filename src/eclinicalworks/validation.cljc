(ns eclinicalworks.validation
  ...
  / ADR-2607083100 EHR-compat increments). Ported by value -- each actor
  stays a standalone deploy unit -- rather than by adding a cross-repo
  dependency, so every clean-room healthcare actor in this cohort agrees on
  what counts as a structurally valid NPI / ICD-10-CM code / procedure code
  / GDPR Art. 9(2) lawful-basis point-letter.
